...
export default function ModalEditarPlato({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div
        className="bg-[#FFFFFF] max-w-lg w-full overflow-hidden"
        style={{ animation: 'slideUp 0.3s ease-out', borderTop: '6px solid #8CC63F' }}
      >
        {/* Header */}
        <div className="relative px-6 py-6 border-b border-[#E7E7E2] bg-gradient-to-r from-[#F5F5F0] to-white">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3 flex-1">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#201E1D] leading-tight">
                  Cambiar plato
                </h2>
            ...
            <button
              onClick={onClose}
              disabled={isLoading}
              className="text-[#9A9A93] hover:text-[#201E1D] transition p-1  hover:bg-[#F5F5F0]"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="px-6 py-6 space-y-5">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-[#F5F5F0]  border border-[#E7E7E2]">
                <Calendar className="w-4 h-4 text-[#8CC63F] flex-shrink-0" />
                <span className="text-sm font-medium text-[#201E1D]">{fechaLegible}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="px-4 py-3 bg-[#F5F5F0]  border border-[#E7E7E2]">
                <span className="text-sm font-medium text-[#201E1D]">{categoria}</span>
              </div>
            </div>
          </div>
          ...
          {platoActual && (
            <div className="p-4  border-l-4" style={{
              ...
              <p className="text-sm font-medium text-[#201E1D]">{platoActualNombre}</p>
            </div>
          )}
          ...
          <div>
            ...
            <select
              ...
              disabled={isLoading}
              className="w-full  border-2 border-[#E7E7E2] px-4 py-3 text-sm text-[#201E1D] font-medium outline-none transition-all focus:border-[#8CC63F] focus:ring-2 focus:ring-[#8CC63F]/20"
            >
            ...
            {platosDisponibles.length === 0 && (
              <div className="mt-2 flex items-start gap-2 p-3 bg-amber-50  border border-amber-200">
        ...
        <div className="px-6 py-4 bg-[#F5F5F0] border-t border-[#E7E7E2] flex gap-3">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="flex-1 py-2.5 px-4  border border-[#E7E7E2] text-[#6B6B65] font-semibold hover:bg-[#FFFFFF] transition disabled:opacity-50"
          >
            Cancelar
          </button>
          <button
            ...
            className="flex-1 py-2.5 px-4  font-semibold text-white transition disabled:opacity-50 flex items-center justify-center gap-2"
            style={{
